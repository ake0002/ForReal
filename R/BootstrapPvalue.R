#' Bootstrap Testing
#'
#' @description This function will allow us to view the p-value and to determine whether we should reject or fail to reject the null hypothesis
#'
#' @param x1 -sample 1
#' @param x2 -sample 2
#' @param conf.level -desired confidence
#' @param iter -iterations
#' @param mudiff -difference in means of the samples
#' @param test -which test to use
#'
#' @return
#' @export
#'
#' @examples
#' \dontrun boot2pval(x1=x,x2=y)
